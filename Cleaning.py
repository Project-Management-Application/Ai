...
def main():
    """
    Main function to process only the project management data file.
    """
    input_file = 'Data/project_management_data.txt'
    output_file = 'Data/project_management_spacy_segmented.json'
